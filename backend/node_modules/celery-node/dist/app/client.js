...
var Client = /** @class */ (function (_super) {
    ...
    Client.prototype.sendTaskMessage = function (taskName, message) {
        var _this = this;
        var headers = message.headers, properties = message.properties, body = message.body, sentEvent = message.sentEvent;
        var exchange = "";
        // exchangeType = 'direct';
        var routingKey = "celery";
        // const serializer = 'json';
        this.isReady().then(function () {
            return _this.broker.publish(body, exchange, routingKey, headers, properties);
        });
    };
